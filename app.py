...
def index():
    ...
    return render_template('jdida.html', car_owner_counts_json=car_owner_counts_json,total_amount_eur=total_amount_eur,total_amount_usd=total_amount_usd,total_amount_gbp=total_amount_gbp)
